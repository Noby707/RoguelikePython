...
def render_all(con, entities, player, game_map, fov_map, screen_width, screen_height, colors):
    ...
    entities_in_renderorder = sorted(entities, key=lambda x: x.render_order.value)

    # Draw all entities in the list
    for entity in entities_in_renderorder:
